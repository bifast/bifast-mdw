...
@Component
public class SaveChannelRequestProc implements Processor{
	@Autowired
	private ChannelTransactionRepository channelTransactionRepo;
	
	private static Logger logger = LoggerFactory.getLogger(SaveChannelRequestProc.class);
	...
	public void process(Exchange exchange) throws Exception {
		...
		logger.debug("["+ rmw.getMsgName() + ":" + rmw.getRequestId() + "] channelTransaction dgn response " + responseWr.getResponseCode());
