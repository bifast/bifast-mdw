...
public class Pacs008Seed {
	...
	public String getEndToEndId() {
		return Optional.ofNullable(endToEndId).orElse("");
	}
	...
	public String getDbtrType() {
		return Optional.ofNullable(dbtrType).orElse("");
	}
	...
	public String getCrdtType() {
		return Optional.ofNullable(crdtType).orElse("");
	}
	...
	public String getDbtrResidentStatus() {
		return Optional.ofNullable(dbtrResidentStatus).orElse("");
	}
	...
	public String getDbtrTownName() {
		return Optional.ofNullable(dbtrTownName).orElse("");
	}
	...
	public String getCrdtResidentStatus() {
		return Optional.ofNullable(crdtResidentStatus).orElse("");
	}
	...
	public String getCrdtTownName() {
		return Optional.ofNullable(crdtTownName).orElse("");
	}
	...
	public String getCrdtProxyIdValue() {
		return Optional.ofNullable(crdtProxyIdValue).orElse("");
	}
