...
public class FdsInputDAO {
	...
	private String beneficierResidencyStatus;
	...
	public String getRekSumber() {
		return rekSumber;
	}
	public void setRekSumber(String rekSumber) {
	...
	public String getBeneficierResidencyStatus() {
		return beneficierResidencyStatus;
	}
	public void setBeneficierResidencyStatus(String beneficierResidencyStatus) {
		this.beneficierResidencyStatus = beneficierResidencyStatus;
	}
